...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Catalog = new()
    {
        [Fallback] = new()
        {
            ...
            ["tray.break"] = "Take a break",
            ["tray.break.granted"] = "Break started — {0} min. Enjoy it!",
            ["tray.break.denied.disabled"] = "Breaks are turned off.",
            ["tray.break.denied.budget"] = "No break time left for today.",
            ["tray.break.denied.cooldown"] = "Too soon for another break — try again in {0} min.",
            ["tray.break.denied.active"] = "Use the computer a little longer before taking a break.",
            ["tray.break.denied.timelow"] = "Not enough screen time left for a break.",
        ...
        ["de"] = new()
        {
            ...
            ["tray.break"] = "Pause machen",
            ["tray.break.granted"] = "Pause gestartet — {0} Min. Viel Spaß!",
            ["tray.break.denied.disabled"] = "Pausen sind deaktiviert.",
            ["tray.break.denied.budget"] = "Heute keine Pausenzeit mehr übrig.",
            ["tray.break.denied.cooldown"] = "Noch zu früh für die nächste Pause — in {0} Min erneut versuchen.",
            ["tray.break.denied.active"] = "Nutze den Computer etwas länger, bevor du eine Pause machst.",
            ["tray.break.denied.timelow"] = "Nicht genug Bildschirmzeit für eine Pause übrig.",
